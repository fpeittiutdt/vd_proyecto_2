                  ...
                  {#if parseInt(rating(entry.favRate)) == 1}
                    <div class="data-entry">
                      ...
                      >
                        ...
                        <path id="blob1" fill="url(#gradient{id}_{month_i}_2)">
                          <animate
                            attributeName="d"
                            dur="{Math.abs(episodes(entry.episodes))}ms"
                            repeatCount="indefinite"
                  ...
                  {:else if parseInt(rating(entry.favRate)) == 2}
                    <div class="data-entry">
                      ...
                      >
                        ...
                        <path id="blob2" fill="url(#gradient{id}_{month_i}_2)">
                          <animate
                            attributeName="d"
                            dur="{Math.abs(episodes(entry.episodes))}ms"
                            repeatCount="indefinite"
                  ...
                  {:else if parseInt(rating(entry.favRate)) == 3}
                    <div class="data-entry">
                      ...
                      >
                        ...
                        <path id="blob3" fill="url(#gradient{id}_{month_i}_2)">
                          <animate
                            attributeName="d"
                            dur="{Math.abs(episodes(entry.episodes))}ms"
                            repeatCount="indefinite"
                  ...
                  {:else if parseInt(rating(entry.favRate)) == 4}
                    <div class="data-entry">
                      ...
                      >
                        ...
                        <path id="blob4" fill="url(#gradient{id}_{month_i}_2)">
                          <animate
                            attributeName="d"
                            dur="{Math.abs(episodes(entry.episodes))}ms"
                            repeatCount="indefinite"
